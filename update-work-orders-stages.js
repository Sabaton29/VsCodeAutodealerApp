...
'
import { KANBAN_STAGES_ORDER } from './constants.js';

// Configuración de Supabase
'
const supabaseUrl = 'https://yfqyqjqjqjqjqjqj.supabase.co'; // Reemplaza con tu URL
'
const supabaseKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...'; // Reemplaza con tu key

const supabase = createClient(supabaseUrl, supabaseKey);

// Mapeo de etapas (ajusta según tu base de datos)
const STAGE_MAPPING = {
'
    'RECEPCION': 'RECEPCION',
'
