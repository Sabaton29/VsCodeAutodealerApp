...
const SettingsView: React.FC<SettingsViewProps> = (props) => {
    const { 
        ...
        onAssignAccounts, onUpdateAllWorkOrderStages, onRestoreIncorrectlyCompletedOrders, onFixOrdersWithQuoteStageMismatch,
    } = props;
    ...
    const renderContent = () => {
        ...
        switch (activeTab) {
            ...
            case 'Operaciones':
                ...
                onRestoreIncorrectlyCompletedOrders={onRestoreIncorrectlyCompletedOrders}
                onFixOrdersWithQuoteStageMismatch={onFixOrdersWithQuoteStageMismatch}
