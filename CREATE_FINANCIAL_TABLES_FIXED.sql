-- =====================================================
-- SCRIPT CORREGIDO: CREAR TABLAS FINANCIERAS
-- =====================================================
-- Este script crea solo las tablas financieras sin tocar work_orders
...
-- 7. INSERTAR DATOS DE EJEMPLO (solo si locations existe)
-- =====================================================
DO $$
BEGIN
    ...
    ELSE
        RAISE NOTICE '⚠️ Tabla locations no encontrada, saltando inserción de datos de ejemplo';
    END IF;
END $$;
